...
|**수업중에 만든 파일들**|
|:---|
|[es_router.py](./workspace_python/07_elastic/router/es_router.py)|
|[data.json](./workspace_python/07_elastic/data/data.json)|
|[config.py](./workspace_python/07_elastic/config.py)|
|[api.py](./workspace_python/07_elastic/api.py)|
