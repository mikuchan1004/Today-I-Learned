## 2026.09.21(월)
## 엘라스틱서치 실습(2) - 엘라스틱서치 텍스트 임베딩 생성 및 청크 데이터 적재 라우터 
...
|**수업 중 만든 파일들**|
|:---|
|[embedding_router.py](./workspace_python/07_elastic/router/embedding_router.py)|
|[utill.py](./workspace_python/07_elastic/utill.py)|
